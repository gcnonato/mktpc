(function () {
    CKEDITOR.dialog.add('youtube', function (editor) {
        return {
            ...
            onOk: function () {
                var text = '<iframe title="YouTube video player" class="youtube-player" type="text/html" width="480" height="390" src="http://www.youtube.com/embed/' + this.getContentElement('general', 'content').getInputElement().getValue() + '?rel=0" frameborder="0"></iframe>';
